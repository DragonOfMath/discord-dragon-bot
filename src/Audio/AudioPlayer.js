 ...
 * Handles audio streaming in a voice channel.
 * @class AudioPlayer
 * @prop {Array<Track>} playlist - the current playlist of the player
 * @prop {Number} index - the index of the current track being played
 * @prop {Boolean} loopTrack - whether to loop the current track
 * @prop {Boolean} loopPlaylist - whether to loop the entire playlist
 * @prop {VoiceSession} vc - the current voice channel session
 * @prop {ReadableStream} readableStream - a stream to read audio data from
 * @prop {AudioCB} audioContext - the context of the audio stream
 */
class AudioPlayer {
	constructor() {
